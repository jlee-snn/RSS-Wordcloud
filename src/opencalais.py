# -*- coding: utf-8 -*-
"""
Created on Thu Oct 29 15:34:20 2015

@author: chris neimeth
"""

###### this file needs to be run from the terminal and needs to include the following elements:
###### 1.input file full path, 2.output directory and 3.access token
###### an example of what is submitted in the terminal is: 
######       Chris-Neimeths-Airs-MacBook-Air:chris chris$ python opencalais.py testarticle.txt output.txt vdTPENVkGe6Pmvn4WIzkIaO8w1QBGcvr
###### my opencalais token is: vdTPENVkGe6Pmvn4WIzkIaO8w1QBGcvr
